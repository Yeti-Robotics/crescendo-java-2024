...
public class RobotContainer {
    ...
    public final ControllerContainer controllerContainer = new ControllerContainer();
    public final ButtonHelper buttonHelper = new ButtonHelper(controllerContainer.getControllers());
