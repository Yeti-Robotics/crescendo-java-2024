...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        buttonHelper.createButton(4, 0, elevator.goDownAndStop(0.2).withTimeout(0.3).andThen(elevator.setPositionDown()).andThen(pivot.movePivotPositionTo(PivotSubsystem.PivotConstants.PivotPosition.HANDOFF)), MultiButton.RunCondition.WHEN_PRESSED);
        ...
        buttonHelper.createButton(9, 0, elevator.setPositionAmp() .andThen(pivot.moveDown(-0.25).unless(
