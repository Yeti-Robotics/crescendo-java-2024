...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(3).withKI(0).withKD(0.0) //0.2 KS - 0, KV, 1.5
        .withKS(0.95) .withKV(0).withKA(0);
    ...
    private static final double kFrontLeftEncoderOffset = 0.406006;
    ...
    private static final double kFrontRightEncoderOffset = -0.339355;
    ...
    private static final double kBackLeftEncoderOffset = -0.428711;
    ...
    private static final double kBackRightEncoderOffset = 0.436035;
