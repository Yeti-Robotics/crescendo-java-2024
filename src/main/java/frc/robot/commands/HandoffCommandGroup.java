...
public class HandoffCommandGroup extends SequentialCommandGroup {
    ...
    public HandoffCommandGroup(
        ...
        addCommands(
                //                new StartEndCommand(() -> intakeSubsystem.roll(.60),
                // intakeSubsystem::stop).withTimeout(.2),
                new InstantCommand(() -> pivotSubsystem.setPivotPosition(0.5))
                        .andThen(
                                new StartEndCommand(() -> armSubsystem.moveUp(.5), armSubsystem::stop)
                                        ...
                                        .andThen(
                                                new StartEndCommand(
                                                        ...
                                                        .alongWith(
                                                                new StartEndCommand(
                                                                        () -> intakeSubsystem.roll(-.35), intakeSubsystem::stop)))
