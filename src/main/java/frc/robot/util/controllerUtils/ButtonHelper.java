...
public class ButtonHelper {
    ...
    /**
     * Creates a MultiButton from a normal push-type button on a controller This method does not bind
     * any commands. It is just to instantiate a button.
     *
     * @param buttonPort the button's port number
     * @return instance of the MultiButton created. Does not have to be stored.
     */
    ...
    public MultiButton createPOVButton(
        ...
        return createButton(povSupplier, getButtonID(povPort, direction), layer, command, runCondition);
    }

    /**
     * Creates a MultiButton from a POV button on a controller This method does not bind any commands.
     * It is just to instantiate a button.
     *
     * @param povPort the POV's port number
     * @param direction the direction of the POV
     * @return instance of the MultiButton created. Does not have to be stored.
    ...
    /**
     * Returns a unique byte base on the type of button and its port number. This is used to identify
     * each button.
     *
     * <p>The first 6 bits represents the button's port number. The 7th and 8th bits represents the
     * button type. If the 7th bit is true, then the button is an axis; 8th bit is true, then it is a
     * POV. If both bits are false, then it is a normal button; both are false, then it is an invalid
     * button
     *
